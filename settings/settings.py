...
#Default auth model
AUTH_USER_MODEL = 'datachimp.User'
...
#SOCIALACCOUNT_ADAPTER = 'datachimp.adapters.datachimpSocialAccountAdapter'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "datachimp/templates/assets"),
]
